...
function acf_responsive_image($img_id=null,$classes=array()){
  if(!is_null($img_id)){
    ...
    if($src!=false){
      ...
      echo '<img src="'.$src.'" srcset="'.$srcset.'" sizes="(max-width:305px) 300px,(max-width:770px) 768px,(max-width:1025px) 1024px" class="'.$string_class.'" alt="image">';
    }
  }
}
